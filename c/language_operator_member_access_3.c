/*
gcc -std=c17 -lc -lm -pthread -o ../_build/c/language_operator_member_access_3.exe ./c/language_operator_member_access_3.c && (cd ../_build/c/;./language_operator_member_access_3.exe)
