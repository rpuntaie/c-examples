/*
gcc -std=c99 -pthread -o ../_build/c/language_operator_member_access_3.exe ./c/language_operator_member_access_3.c && (cd ../_build/c/;./language_operator_member_access_3.exe)
