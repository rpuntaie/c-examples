/*
gcc -std=c17 -lc -lm -pthread -o ../_build/c/language_operator_comparison_1.exe ./c/language_operator_comparison_1.c && (cd ../_build/c/;./language_operator_comparison_1.exe)
