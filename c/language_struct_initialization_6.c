/*
gcc -std=c99 -pthread -o ../_build/c/language_struct_initialization_6.exe ./c/language_struct_initialization_6.c && (cd ../_build/c/;./language_struct_initialization_6.exe)
