/*
g++ --std=c++20 -pthread -o ../_build/cpp/types_is_default_constructible.exe ./cpp/types_is_default_constructible.cpp && (cd ../_build/cpp/;./types_is_default_constructible.exe)
