/*
g++ --std=c++20 -pthread -o ../_build/cpp/container_list_rend.exe ./cpp/container_list_rend.cpp && (cd ../_build/cpp/;./container_list_rend.exe)
https://en.cppreference.com/w/cpp/container/list/rend
*/
#include <algorithm>
#include <iostream>
#include <numeric>
