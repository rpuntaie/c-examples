/*
g++ --std=c++20 -pthread -o ../_build/cpp/container_vector_bool_hash.exe ./cpp/container_vector_bool_hash.cpp && (cd ../_build/cpp/;./container_vector_bool_hash.exe)
https://en.cppreference.com/w/cpp/container/vector_bool/hash
*/
#include <iostream>
