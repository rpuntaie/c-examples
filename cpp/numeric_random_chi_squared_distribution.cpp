/*
g++ --std=c++20 -pthread -o ../_build/cpp/numeric_random_chi_squared_distribution.exe ./cpp/numeric_random_chi_squared_distribution.cpp && (cd ../_build/cpp/;./numeric_random_chi_squared_distribution.exe)
