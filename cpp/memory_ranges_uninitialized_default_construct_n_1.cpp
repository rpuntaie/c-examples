/*
g++ --std=c++20 -pthread -o ../_build/cpp/memory_ranges_uninitialized_default_construct_n_1.exe ./cpp/memory_ranges_uninitialized_default_construct_n_1.cpp && (cd ../_build/cpp/;./memory_ranges_uninitialized_default_construct_n_1.exe)
