/*
g++ --std=c++20 -pthread -o ../_build/cpp/language_function_template_14.exe ./cpp/language_function_template_14.cpp && (cd ../_build/cpp/;./language_function_template_14.exe)
