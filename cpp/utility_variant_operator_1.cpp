/*
g++ --std=c++20 -pthread -o ../_build/cpp/utility_variant_operator_1.exe ./cpp/utility_variant_operator_1.cpp && (cd ../_build/cpp/;./utility_variant_operator_1.exe)
https://en.cppreference.com/w/cpp/utility/variant/operator=
*/
#include <iomanip>
#include <iostream>
#include <string>
