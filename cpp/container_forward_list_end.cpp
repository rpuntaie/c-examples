/*
g++ --std=c++20 -pthread -o ../_build/cpp/container_forward_list_end.exe ./cpp/container_forward_list_end.cpp && (cd ../_build/cpp/;./container_forward_list_end.exe)
https://en.cppreference.com/w/cpp/container/forward_list/end
*/
#include <algorithm>
#include <iostream>
#include <numeric>
