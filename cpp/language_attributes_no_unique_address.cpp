/*
g++ --std=c++20 -pthread -o ../_build/cpp/language_attributes_no_unique_address.exe ./cpp/language_attributes_no_unique_address.cpp && (cd ../_build/cpp/;./language_attributes_no_unique_address.exe)
