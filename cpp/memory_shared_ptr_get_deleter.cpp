/*
g++ --std=c++20 -pthread -o ../_build/cpp/memory_shared_ptr_get_deleter.exe ./cpp/memory_shared_ptr_get_deleter.cpp && (cd ../_build/cpp/;./memory_shared_ptr_get_deleter.exe)
