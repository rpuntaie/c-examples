/*
g++ --std=c++20 -pthread -o ../_build/cpp/container_unordered_multimap_swap.exe ./cpp/container_unordered_multimap_swap.cpp && (cd ../_build/cpp/;./container_unordered_multimap_swap.exe)
https://en.cppreference.com/w/cpp/container/unordered_multimap/swap
*/
#include <iostream>
#include <string>
#include <utility>
