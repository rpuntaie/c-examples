/*
g++ --std=c++20 -pthread -o ../_build/cpp/numeric_valarray_operator_arith3.exe ./cpp/numeric_valarray_operator_arith3.cpp && (cd ../_build/cpp/;./numeric_valarray_operator_arith3.exe)
