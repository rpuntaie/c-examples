/*
g++ --std=c++20 -pthread -o ../_build/cpp/utility_functional_unary_function.exe ./cpp/utility_functional_unary_function.cpp && (cd ../_build/cpp/;./utility_functional_unary_function.exe)
