/*
g++ --std=c++20 -pthread -o ../_build/cpp/container_multimap_end.exe ./cpp/container_multimap_end.cpp && (cd ../_build/cpp/;./container_multimap_end.exe)
https://en.cppreference.com/w/cpp/container/multimap/end
*/
#include <algorithm>
#include <cassert>
#include <iostream>
