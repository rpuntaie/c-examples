/*
g++ --std=c++20 -pthread -o ../_build/cpp/language_list_initialization_1.exe ./cpp/language_list_initialization_1.cpp && (cd ../_build/cpp/;./language_list_initialization_1.exe)
