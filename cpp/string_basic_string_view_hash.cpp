/*
g++ --std=c++20 -pthread -o ../_build/cpp/string_basic_string_view_hash.exe ./cpp/string_basic_string_view_hash.cpp && (cd ../_build/cpp/;./string_basic_string_view_hash.exe)
