/*
g++ --std=c++20 -pthread -o ../_build/cpp/language_copy_initialization_2.exe ./cpp/language_copy_initialization_2.cpp && (cd ../_build/cpp/;./language_copy_initialization_2.exe)
