/*
g++ --std=c++20 -pthread -o ../_build/cpp/locale_money_get.exe ./cpp/locale_money_get.cpp && (cd ../_build/cpp/;./locale_money_get.exe)
https://en.cppreference.com/w/cpp/locale/money_get
*/
#include <iostream>
#include <sstream>
#include <locale>
