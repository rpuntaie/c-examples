/*
g++ --std=c++20 -pthread -o ../_build/cpp/container_deque_rend.exe ./cpp/container_deque_rend.cpp && (cd ../_build/cpp/;./container_deque_rend.exe)
https://en.cppreference.com/w/cpp/container/deque/rend
*/
#include <algorithm>
#include <iostream>
#include <numeric>
