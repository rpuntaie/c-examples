/*
g++ --std=c++20 -pthread -o ../_build/cpp/algorithm_lexicographical_compare_three_way_1.exe ./cpp/algorithm_lexicographical_compare_three_way_1.cpp && (cd ../_build/cpp/;./algorithm_lexicographical_compare_three_way_1.exe)
