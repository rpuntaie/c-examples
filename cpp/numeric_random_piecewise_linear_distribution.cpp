/*
g++ --std=c++20 -pthread -o ../_build/cpp/numeric_random_piecewise_linear_distribution.exe ./cpp/numeric_random_piecewise_linear_distribution.cpp && (cd ../_build/cpp/;./numeric_random_piecewise_linear_distribution.exe)
