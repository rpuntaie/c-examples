/*
g++ --std=c++20 -latomic -pthread -o ../_build/cpp/atomic_atomic_fetch_and.exe ./cpp/atomic_atomic_fetch_and.cpp && (cd ../_build/cpp/;./atomic_atomic_fetch_and.exe)
https://en.cppreference.com/w/cpp/atomic/atomic_fetch_and
*/
#include <iostream>
#include <atomic>
#include <thread>
