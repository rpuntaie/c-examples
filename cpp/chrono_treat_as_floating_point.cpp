/*
g++ --std=c++20 -pthread -o ../_build/cpp/chrono_treat_as_floating_point.exe ./cpp/chrono_treat_as_floating_point.cpp && (cd ../_build/cpp/;./chrono_treat_as_floating_point.exe)
