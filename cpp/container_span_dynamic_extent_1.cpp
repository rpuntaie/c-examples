/*
g++ --std=c++20 -pthread -o ../_build/cpp/container_span_dynamic_extent_1.exe ./cpp/container_span_dynamic_extent_1.cpp && (cd ../_build/cpp/;./container_span_dynamic_extent_1.exe)
