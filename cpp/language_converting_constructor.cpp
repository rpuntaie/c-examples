/*
g++ --std=c++20 -pthread -o ../_build/cpp/language_converting_constructor.exe ./cpp/language_converting_constructor.cpp && (cd ../_build/cpp/;./language_converting_constructor.exe)
