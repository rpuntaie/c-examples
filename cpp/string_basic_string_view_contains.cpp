/*
g++ --std=c++23 -pthread -o ../_build/cpp/string_basic_string_view_contains.exe ./cpp/string_basic_string_view_contains.cpp && (cd ../_build/cpp/;./string_basic_string_view_contains.exe)
