/*
g++ --std=c++20 -pthread -o ../_build/cpp/utility_functional_binary_function.exe ./cpp/utility_functional_binary_function.cpp && (cd ../_build/cpp/;./utility_functional_binary_function.exe)
