/*
g++ --std=c++20 -pthread -o ../_build/cpp/container_forward_list_unique.exe ./cpp/container_forward_list_unique.cpp && (cd ../_build/cpp/;./container_forward_list_unique.exe)
