/*
g++ --std=c++20 -pthread -o ../_build/cpp/numeric_valarray_operator.exe ./cpp/numeric_valarray_operator.cpp && (cd ../_build/cpp/;./numeric_valarray_operator.exe)
https://en.cppreference.com/w/cpp/numeric/valarray/operator=
*/
#include <iomanip>
#include <iostream>
#include <valarray>
